      ...
      <div className="flex-1 lg:ml-[260px]">
        ...
        <div className="p-8 max-w-4xl mx-auto">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <div className="bg-[rgba(255,255,255,0.05)] border border-[rgba(183,222,232,0.1)] rounded-lg p-6 space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="fullName" className="text-[#B7DEE8] text-sm font-medium">
                  ...
                  <input
                    ...
                    className="mt-1 w-full bg-[rgba(255,255,255,0.1)] border border-[rgba(183,222,232,0.2)] rounded-lg px-4 py-3 text-white placeholder-[rgba(255,255,255,0.5)] focus:outline-none focus:ring-2 focus:ring-[#B7DEE8] focus:border-transparent"
                    placeholder={t('أدخل اسمك الكامل', 'Enter your full name')}
                  />
                </div>

                <div>
                  <Label htmlFor="email" className="text-[#B7DEE8] text-sm font-medium">
                  ...
                  <input
                    ...
                    value={user?.email || ''}
                    disabled
                    className="mt-1 w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(183,222,232,0.1)] rounded-lg px-4 py-3 text-[rgba(255,255,255,0.7)] cursor-not-allowed"
                  />
                </div>

                <div>
                  <Label htmlFor="phoneNumber" className="text-[#B7DEE8] text-sm font-medium">
                ...
                <div>
                  <Label htmlFor="language" className="text-[#B7DEE8] text-sm font-medium">
                    {t('اللغة المفضلة', 'Preferred Language')}
                  </Label>
                  <Select value={preferredLanguage} onValueChange={setPreferredLanguage}>
                    <SelectTrigger className="mt-1 w-full bg-[rgba(255,255,255,0.1)] border border-[rgba(183,222,232,0.2)] text-white">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent className="bg-[rgba(255,255,255,0.1)] border border-[rgba(183,222,232,0.2)]">
                      <SelectItem value="ar" className="text-white hover:bg-[rgba(183,222,232,0.1)]">العربية</SelectItem>
                      <SelectItem value="en" className="text-white hover:bg-[rgba(183,222,232,0.1)]">English</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#B7DEE8] hover:bg-[#9BCBD8] text-[#0C2836] font-medium py-3 px-6 rounded-lg transition-colors"
                >
