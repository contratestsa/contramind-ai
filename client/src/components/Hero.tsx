        ...
        <div className="text-center">
          ...
          >
            ...
            <motion.h1
              ...
              className={`text-4xl lg:text-6xl leading-tight sm:leading-snug md:leading-normal lg:leading-relaxed xl:leading-normal pt-[12px] pb-[12px] pl-[-3px] pr-[-3px] ml-[-22px] mr-[-22px] mt-[19px] mb-[19px] ${language === 'ar' ? 'font-arabic-heading-bold' : 'font-heading font-bold'}`}
            >
