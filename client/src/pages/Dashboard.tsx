        ...
        <div className="flex-shrink-0 bg-[#0C2836] px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="mr-6 px-3 py-1.5 bg-[rgba(183,222,232,0.1)] hover:bg-[rgba(183,222,232,0.2)] rounded-md transition-all duration-200 text-sm font-medium text-white flex items-center gap-2"
            >
          ...
          <div className="flex flex-col h-full bg-[#0C2836] relative">
            ...
            <div className="flex-1 overflow-y-auto flex flex-col">
              <div className="max-w-3xl mx-auto w-full p-4 flex flex-col flex-1">
                ...
                {messages.length === 0 && (
                  <div className="text-center pt-32 pb-8 mb-32 transition-all duration-300">
