...
- **Logo Brand Guidelines**: Large, prominent logo sizing (h-16 md:h-20 lg:h-24) with proper spacing (0.5× logomark height clear space) to serve as effective brand identifier
