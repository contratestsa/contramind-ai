            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <Input
                  ...
                  className="w-full px-4 py-3 border border-grey rounded-custom focus:ring-2 focus:ring-sky focus:border-sky transition-colors bg-white !text-black placeholder:text-gray-300"
